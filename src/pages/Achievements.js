...
const Achievements = () => {
  ...
  const projectData = [
...

    {
      ...
      description:
        'Awarded by Malaysia Digital Economic Corporation (MDEC) in Pakej Rangsangan Industri Kreatif Malaysia (PRISMA) Digital Content Grant. 🏆 Honored to be recognized by Malaysia Digital Economic Corporation (MDEC) in the PRISMA Digital Content Grant! 🚀 Excited to have made it to the Top 100 Creative Streamers, a testament to the power of digital creativity in shaping the future. 🎮💡',
      tech_stack: ['Streaming', 'MDEC', 'OBS Studio'],
      source_link:
    ...
    {
      image_url:
        'https://media.licdn.com/dms/image/D562DAQG_snY7mm9S0Q/profile-treasury-image-shrink_800_800/0/1686223113584?e=1699966800&v=beta&t=fyZ9gCfFxzdFyW-n2KxSgJkaon_9tSZv4ExoznlUHuM',
      project_name:
        'Inter-University E-Sport Competition (MASUM) - Valorant UPM Team ',
      description:
